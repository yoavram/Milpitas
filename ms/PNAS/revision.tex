...
\noindent (b): \ $\hat\rho$ is the rate that maximizes the geometric mean fitness at \hfill\par
\qquad\  the stable equilibrium of the $AkBl$ cycle.\hfill\par
\noindent \ \ $\dagger$:\hskip.105truein Note: $W=1$.\hfill\par
}
\end{table}
