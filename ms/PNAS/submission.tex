...
\begin{figure}[h]
\centering
\includegraphics[width=.8\linewidth]{../pnas_submission/A1B2_polymorphism.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=.8\linewidth]{../pnas_submission/stochastic_env_x_t.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=.8\linewidth]{../pnas_submission/stoch_two_iid_rvs.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=.8\linewidth]{../pnas_submission/A1B1_modifier_invasions.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=.8\linewidth]{../pnas_submission/stoch_modifier_invasions.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=.8\linewidth]{../pnas_submission/AkBk_stable_optimal_rate.pdf}
...
%New Figure from old Fig 7 Panel C only
\begin{figure}[h]
\centering
\includegraphics[width=.8\linewidth]{../pnas_submission/lk_fix_prob_C.pdf}
